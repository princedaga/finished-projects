...
while True:
    ...
    cv2.putText(frame,str(fps) + " FPS", (10,20), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (200,0,0),2)
    showKey.drawKey(frame,(255,255,255), (200,0,0),0.1, fontScale=0.5)
    exitKey.drawKey(frame,(255,255,255), (200,0,0),0.1, fontScale=0.5)
    ...
    alpha = 0.5
    if show:
        textBox.drawKey(frame, (255,255,255), (200,0,0), 0.3)
        for k in keys:
            ...
            k.drawKey(frame,(255,255,255), (200,0,0), alpha=alpha)
            alpha = 0.5
        clickedX, clickedY = 0, 0        
    ptime = ctime
